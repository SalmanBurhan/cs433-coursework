 ...
 */
void SchedulerSJF::process_sort_burst_time()
{
    sort(this->processes.begin(), this->processes.end(),
         [](PCB a, PCB b)
         { return tie(a.burst_time, a.id) < tie(b.burst_time, b.id); });
}
/**
 * @brief This function sorts the processes in the ready queue by
 ...
 *        the smaller id.
 */
void SchedulerSJF::process_sort_default()
{
    sort(this->processes.begin(), this->processes.end(),
         [](PCB a, PCB b)
 ...
 *        in the ready queue.
 */
void SchedulerSJF::simulate_run_order()
{
...
/**
 * @brief This function calculates the waiting_time and turnaround_time of
 *        each process in the ready queue.
 */
void SchedulerSJF::calculate_times()
{
    this->processes[0].waiting_time = 0;
    this->processes[0].turnaround_time =
        this->processes[0].burst_time;
